var TR = {
  ...
  aiModelImageToMesh: 'Image to Mesh',
  aiModelStyleTransfer: 'Style Transfer',
  aiModelAutoRigging: 'Auto rigging',
  ...
  aiGenerate: 'Generate Mesh',
  aiRefine: 'Refine',
  aiOptimize: 'Optimize Mesh',
  aiProgress: 'Progress',
  aiUploadTitle: 'Step 1: Upload Image',
    aiUploadImage: 'Upload Image',
    aiReuploadImage: 'Re-upload Image',
    aiImagePreview: 'Preview Image',
    aiImageInfo: 'Image Info',
  aiGenerateTitle: 'Step 2: Generate Model',
  aiGenerateModel: 'Generate 3D Model',
  aiDownloadTitle: 'Step 3: Download Model',
  aiDownloadModel: 'Download OBJ Model',
  aiStatus: 'Status',
  aiStatusReady: 'Ready',
  aiStatusImageUploaded: 'Image Uploaded',
  aiStatusGenerating: 'Generating Model...',
  aiStatusComplete: 'Model Generation Complete',
  aiStatusError: 'Generation Failed',
  aiStatusDownloaded: 'Model Downloaded',
