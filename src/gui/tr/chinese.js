var TR = {
  ...
  fileAutoMatrix: '缩放并居中',
  fileVertexSRGB: 'sRGB 顶点色彩',
  fileExportSceneTitle: '导出场景',
  fileExportAll: '导出全部',
  fileExportSGL: '保存 .sgl (SculptGL)',
  fileExportOBJ: '保存 .obj',
  fileExportPLY: '保存 .ply',
  fileExportSTL: '保存 .stl',
  ...
  aiModelImageToMesh: '图片生成网格',
  aiModelStyleTransfer: '风格迁移',
  aiModelAutoRigging: '自动绑定',
  aiParameters: 'AI参数',
  aiStrength: 'AI强度',
  aiQuality: '质量',
  aiQualityLow: '低',
  ...
  aiOptimize: '优化网格',
  aiProgress: 'AI处理进度',
  aiUploadTitle: '步骤1: 上传图片',
  aiUploadImage: '上传图片',
  aiReuploadImage: '重新上传',
  aiImagePreview: '预览图片',
  aiImageInfo: '图片信息',
  aiGenerateTitle: '步骤2: 生成模型',
  aiGenerateModel: '生成3D模型',
  aiDownloadTitle: '步骤3: 下载模型',
  aiDownloadModel: '下载OBJ模型',
  aiStatus: '状态',
  aiStatusReady: '准备就绪',
  aiStatusImageUploaded: '图片已上传',
  aiStatusGenerating: '正在生成模型...',
  aiStatusComplete: '模型生成完成',
  aiStatusError: '生成失败',
  aiStatusDownloaded: '模型已下载',
  aiInvalidImage: '请选择有效的图片文件',
  aiNoImageUploaded: '请先上传图片',
  aiNoModelGenerated: '还没有生成模型',
  aiGenerationError: '模型生成失败，请重试',
